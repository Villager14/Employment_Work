...
const std::vector<D3D11_INPUT_ELEMENT_DESC> SpeedScreen::INPUT_LAYOUT =
{
...
//		シェーダーの読み込み
void SpeedScreen::CreateShader()
{
	auto device = LibrarySingleton::GetInstance()->GetDeviceResources()->GetD3DDevice();

	//		コンパイルされたシェーダファイルを読み込み
	BinaryFile PSData = BinaryFile::LoadFile(L"Resources/Shader/SpeedScreen/SpeedScreenPS.cso");
	BinaryFile VSData = BinaryFile::LoadFile(L"Resources/Shader/SpeedScreen/SpeedScreenVS.cso");
	BinaryFile GSData = BinaryFile::LoadFile(L"Resources/Shader/SpeedScreen/SpeedScreenGS.cso");
