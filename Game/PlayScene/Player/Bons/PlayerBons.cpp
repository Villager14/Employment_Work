...
void PlayerBons::CrateBons(DirectX::SimpleMath::Vector3 position,
						   float length, BonsType type, BonsType parent)
{
...
BonsType PlayerBons::ParentProcess(DirectX::SimpleMath::Matrix *world, BonsType modelType)
{
	//		回転量を掛ける
