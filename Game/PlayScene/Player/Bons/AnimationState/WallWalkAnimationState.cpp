...
WallWalkAnimationState::WallWalkAnimationState(PlayerAnimation* playerAnimation)
	:
	m_elapsedTime(0.0f),
	...
	std::vector<PlayerBonsInformation>* bonesInformation)
{
	...
	m_playerAnimation->AnimationMovement(BonsType::RLegUp, bonesInformation, RLegUp, (*bonesInformation)[BonsType::RLegUp].rotation, m_animationTransration);
	m_playerAnimation->AnimationMovement(BonsType::LLegUp, bonesInformation, LLegUp, (*bonesInformation)[BonsType::LLegUp].rotation, m_animationTransration);
	m_playerAnimation->AnimationMovement(BonsType::RLegDown, bonesInformation, RLegDown, (*bonesInformation)[BonsType::RLegDown].rotation, m_animationTransration);
	m_playerAnimation->AnimationMovement(BonsType::LLegDown, bonesInformation, LLegDown, (*bonesInformation)[BonsType::LLegDown].rotation, m_animationTransration);

	m_playerAnimation->AnimationMovement(BonsType::Body, bonesInformation, Body, (*bonesInformation)[BonsType::Body].rotation, m_animationTransration);
}
