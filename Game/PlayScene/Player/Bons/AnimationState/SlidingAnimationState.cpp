...
SlidingAnimationState::SlidingAnimationState(PlayerAnimation* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
	...
	std::vector<PlayerBonsInformation>* bonesInformation)
{
	...
	m_playerAnimation->AnimationMovement(BonsType::BodyDown, bonesInformation, BodyDown, (*bonesInformation)[BonsType::BodyDown].rotation, m_animationTransration);
