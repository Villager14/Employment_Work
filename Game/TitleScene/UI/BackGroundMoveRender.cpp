...
const std::vector<D3D11_INPUT_ELEMENT_DESC> BackGroundMoveRender::INPUT_LAYOUT =
{
...
BackGroundMoveRender::BackGroundMoveRender()
{
}
...
void BackGroundMoveRender::LoadTexture(const wchar_t* path)
{
	//		画像ファイルの読み込み
...
void BackGroundMoveRender::Create(const wchar_t* path,
...
void BackGroundMoveRender::LoadShader()
{
	auto device = LibrarySingleton::GetInstance()->GetDeviceResources()->GetD3DDevice();

	//		コンパイルされたシェーダファイルを読み込み
	BinaryFile VSData = BinaryFile::LoadFile(L"Resources/Shader/BackGroundMove/BackGroundMoveVS.cso");
	BinaryFile GSData = BinaryFile::LoadFile(L"Resources/Shader/BackGroundMove/BackGroundMoveGS.cso");
	BinaryFile PSData = BinaryFile::LoadFile(L"Resources/Shader/BackGroundMove/BackGroundMovePS.cso");
...
void BackGroundMoveRender::Render(float time)
{
	...
	//		時間
	cbuff.time = { time, 0.0f, 0.0f, 0.0f };
